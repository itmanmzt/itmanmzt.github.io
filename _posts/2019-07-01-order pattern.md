...
```
运行结果：
![](https://itmanmzt.github.io/styles/images/minglingi/001.jpg){:align="center"}<br><br>
### 扩展代码实现
...
```
运行结果：
![](https://itmanmzt.github.io/styles/images/minglingi/002.jpg){:align="center"}<br><br>
